...
if __name__ == "__main__":
    ...
    pdf_path = [os.path.join(base_dir, "data/raw/Official EUR-Lex.pdf"), os.path.join(base_dir, "data/raw/EU Commission Guidelines on Prohibited AI.pdf")]
    output_path = [os.path.join(base_dir, "data/processed/clean_eu_ai_act.md"), os.path.join(base_dir, "data/processed/clean_eu_proh_ai_act.md")]
